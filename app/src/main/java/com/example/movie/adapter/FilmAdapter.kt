...
class FilmAdapter(
    private val resultFilms: ArrayList<ResultFilm>,
    private val glideRequestManager: RequestManager,
    private val listener: (result: ResultFilm, view: ImageView, text: TextView) -> Unit
) : RecyclerView.Adapter<FilmAdapter.ResultViewHolder>() {
